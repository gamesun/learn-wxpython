...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.6.7 (standalone edition) on Sun Dec 22 22:58:49 2013
#
...
class myFrame(wx.Frame):
    ...
    def __set_properties(self):
        ...
        self.wdCanvas.SetMinSize((614, 383))
        ...
        self.hyperlink_5.SetForegroundColour(wx.Colour(0, 0, 255))
    ...
    def __do_layout(self):
        ...
        sizer_8.Add(self.hyperlink_1, 0, wx.BOTTOM | wx.ALIGN_CENTER_HORIZONTAL, 1)
        sizer_8.Add(self.hyperlink_2, 0, wx.BOTTOM | wx.ALIGN_CENTER_HORIZONTAL, 1)
        sizer_8.Add(self.hyperlink_3, 0, wx.BOTTOM | wx.ALIGN_CENTER_HORIZONTAL, 1)
        sizer_8.Add(self.hyperlink_4, 0, wx.BOTTOM | wx.ALIGN_CENTER_HORIZONTAL, 1)
        sizer_8.Add(self.hyperlink_5, 0, wx.BOTTOM | wx.ALIGN_CENTER_HORIZONTAL, 1)
        sizer_8.Add(self.hyperlink_6, 0, wx.BOTTOM | wx.ALIGN_CENTER_HORIZONTAL, 1)
        sizer_8.Add(self.hyperlink_7, 0, wx.BOTTOM | wx.ALIGN_CENTER_HORIZONTAL, 1)
        sizer_8.Add(self.hyperlink_8, 0, wx.BOTTOM | wx.ALIGN_CENTER_HORIZONTAL, 1)

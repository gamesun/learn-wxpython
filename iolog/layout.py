...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.6.7 (standalone edition) on Sat Dec 21 00:15:53 2013
#
...
class myFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.label_1 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_1")
        self.label_2 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_2")
        self.label_3 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_3")
        self.label_4 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_4")
        self.label_5 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_5")
        self.label_6 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_6")
        self.label_7 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_7")
        self.label_8 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_8")
        self.label_9 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_9")
        self.label_10 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_10")
        self.label_11 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_11")
        self.label_12 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_12")
        self.label_13 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_13")
        self.label_14 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_14")
        self.label_15 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_15")
        self.label_16 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_16")
        self.label_17 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_17")
        self.label_18 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_18")
        self.label_19 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_19")
        self.label_20 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_20")
        self.label_21 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_21")
        self.label_22 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_22")
        self.label_23 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_24")
        self.label_24 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_24")
        self.label_25 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_25")
        self.label_26 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_26")
        self.label_27 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_27")
        self.label_28 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_28")
        self.label_29 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_29")
        self.label_30 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_30")
        self.label_31 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_31")
        self.label_32 = wx.StaticText(self.wdTitle, wx.ID_ANY, "label_32")
        ...
        self.hyperlink_1 = wx.HyperlinkCtrl(self.pnlMeasure, wx.ID_ANY, "   T1   ", "")
        self.hyperlink_2 = wx.HyperlinkCtrl(self.pnlMeasure, wx.ID_ANY, "   T2   ", "")
        self.hyperlink_3 = wx.HyperlinkCtrl(self.pnlMeasure, wx.ID_ANY, "   T3   ", "")
        self.hyperlink_4 = wx.HyperlinkCtrl(self.pnlMeasure, wx.ID_ANY, "   T4   ", "")
        self.hyperlink_5 = wx.HyperlinkCtrl(self.pnlMeasure, wx.ID_ANY, "   T5   ", "")
        self.hyperlink_6 = wx.HyperlinkCtrl(self.pnlMeasure, wx.ID_ANY, "   T6   ", "")
        self.hyperlink_7 = wx.HyperlinkCtrl(self.pnlMeasure, wx.ID_ANY, "   T7   ", "")
        self.hyperlink_8 = wx.HyperlinkCtrl(self.pnlMeasure, wx.ID_ANY, "   T8   ", "")
    ...
    def __set_properties(self):
        ...
        self.wdCanvas.SetMinSize((547, 472))
        self.wdCanvas.SetScrollRate(10, 10)
    ...
    def __do_layout(self):
        ...
        sizer_8.Add(self.hyperlink_1, 0, 0, 0)
        sizer_8.Add(self.hyperlink_2, 0, 0, 0)
        sizer_8.Add(self.hyperlink_3, 0, 0, 0)
        sizer_8.Add(self.hyperlink_4, 0, 0, 0)
        sizer_8.Add(self.hyperlink_5, 0, 0, 0)
        sizer_8.Add(self.hyperlink_6, 0, 0, 0)
        sizer_8.Add(self.hyperlink_7, 0, 0, 0)
        sizer_8.Add(self.hyperlink_8, 0, 0, 0)
        sizer_8.Add(self.label_33, 0, 0, 0)
        sizer_8.Add(self.label_34, 0, 0, 0)
        sizer_8.Add(self.label_35, 0, 0, 0)
        sizer_8.Add(self.label_36, 0, 0, 0)
        sizer_8.Add(self.label_37, 0, 0, 0)
        sizer_8.Add(self.label_38, 0, 0, 0)
        sizer_8.Add(self.label_39, 0, 0, 0)
        sizer_7.Add(sizer_8, 1, wx.EXPAND, 0)
        sizer_9.Add(self.label_T1, 0, 0, 0)
        sizer_9.Add(self.label_T2, 0, 0, 0)
        sizer_9.Add(self.label_T3, 0, 0, 0)
        sizer_9.Add(self.label_T4, 0, 0, 0)
        sizer_9.Add(self.label_T5, 0, 0, 0)
        sizer_9.Add(self.label_T6, 0, 0, 0)
        sizer_9.Add(self.label_T7, 0, 0, 0)
        sizer_9.Add(self.label_T8, 0, 0, 0)
        sizer_9.Add(self.label_sub12, 0, 0, 0)
        sizer_9.Add(self.label_sub23, 0, 0, 0)
        sizer_9.Add(self.label_sub34, 0, 0, 0)
        sizer_9.Add(self.label_sub45, 0, 0, 0)
        sizer_9.Add(self.label_sub56, 0, 0, 0)
        sizer_9.Add(self.label_sub67, 0, 0, 0)
        sizer_9.Add(self.label_sub78, 0, 0, 0)

...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.6.7 (standalone edition) on Thu Jan 16 22:05:18 2014
#
...
class myFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.lblInfo1 = wx.StaticText(self.pnlMeasure, wx.ID_ANY, "")
        self.lblInfo2 = wx.StaticText(self.pnlMeasure, wx.ID_ANY, "")
        self.lblInfo3 = wx.StaticText(self.pnlMeasure, wx.ID_ANY, "")
        self.lblInfo4 = wx.StaticText(self.pnlMeasure, wx.ID_ANY, "")
        self.lblInfo5 = wx.StaticText(self.pnlMeasure, wx.ID_ANY, "")
        self.lblInfo6 = wx.StaticText(self.pnlMeasure, wx.ID_ANY, "")
    ...
    def __set_properties(self):
        ...
        self.wdCanvas.SetMinSize((527, 526))
        self.wdCanvas.SetScrollRate(10, 1)
        self.lblInfo1.SetFont(wx.Font(10, wx.MODERN, wx.NORMAL, wx.NORMAL, 0, "Consolas"))
        self.lblInfo2.SetFont(wx.Font(10, wx.MODERN, wx.NORMAL, wx.NORMAL, 0, "Consolas"))
        self.lblInfo3.SetFont(wx.Font(10, wx.MODERN, wx.NORMAL, wx.NORMAL, 0, "Consolas"))
        self.lblInfo4.SetFont(wx.Font(10, wx.MODERN, wx.NORMAL, wx.NORMAL, 0, "Consolas"))
        self.lblInfo5.SetFont(wx.Font(10, wx.MODERN, wx.NORMAL, wx.NORMAL, 0, "Consolas"))
        self.lblInfo6.SetFont(wx.Font(10, wx.MODERN, wx.NORMAL, wx.NORMAL, 0, "Consolas"))
    ...
    def __do_layout(self):
        ...
        self.sizerSigLabel = wx.BoxSizer(wx.VERTICAL)
        self.sizerSigLabel.Add(self.label_topSpacer, 0, 0, 0)
        self.sizerSigLabel.Add(self.label_1, 0, wx.EXPAND, 0)
        self.sizerSigLabel.Add(self.label_2, 0, wx.EXPAND, 0)
        self.sizerSigLabel.Add(self.label_3, 0, wx.EXPAND, 0)
        self.sizerSigLabel.Add(self.label_4, 0, wx.EXPAND, 0)
        self.sizerSigLabel.Add(self.label_5, 0, wx.EXPAND, 0)
        self.sizerSigLabel.Add(self.label_6, 0, wx.EXPAND, 0)
        self.sizerSigLabel.Add(self.label_7, 0, wx.EXPAND, 0)
        self.sizerSigLabel.Add(self.label_8, 0, wx.EXPAND, 0)
        self.sizerSigLabel.Add(self.label_9, 0, wx.EXPAND, 0)
        self.sizerSigLabel.Add(self.label_10, 0, wx.EXPAND, 0)
        self.sizerSigLabel.Add(self.label_11, 0, wx.EXPAND, 0)
        self.sizerSigLabel.Add(self.label_12, 0, wx.EXPAND, 0)
        self.sizerSigLabel.Add(self.label_13, 0, wx.EXPAND, 0)
        self.sizerSigLabel.Add(self.label_14, 0, wx.EXPAND, 0)
        self.sizerSigLabel.Add(self.label_15, 0, wx.EXPAND, 0)
        self.sizerSigLabel.Add(self.label_16, 0, wx.EXPAND, 0)
        self.sizerSigLabel.Add(self.label_17, 0, wx.EXPAND, 0)
        self.sizerSigLabel.Add(self.label_18, 0, wx.EXPAND, 0)
        self.sizerSigLabel.Add(self.label_19, 0, wx.EXPAND, 0)
        self.sizerSigLabel.Add(self.label_20, 0, wx.EXPAND, 0)
        self.sizerSigLabel.Add(self.label_21, 0, wx.EXPAND, 0)
        self.sizerSigLabel.Add(self.label_22, 0, wx.EXPAND, 0)
        self.sizerSigLabel.Add(self.label_23, 0, wx.EXPAND, 0)
        self.sizerSigLabel.Add(self.label_24, 0, wx.EXPAND, 0)
        self.sizerSigLabel.Add(self.label_25, 0, wx.EXPAND, 0)
        self.sizerSigLabel.Add(self.label_26, 0, wx.EXPAND, 0)
        self.sizerSigLabel.Add(self.label_27, 0, wx.EXPAND, 0)
        self.sizerSigLabel.Add(self.label_28, 0, wx.EXPAND, 0)
        self.sizerSigLabel.Add(self.label_29, 0, wx.EXPAND, 0)
        self.sizerSigLabel.Add(self.label_30, 0, wx.EXPAND, 0)
        self.sizerSigLabel.Add(self.label_31, 0, wx.EXPAND, 0)
        self.sizerSigLabel.Add(self.label_32, 0, wx.EXPAND, 0)
        self.wdTitle.SetSizer(self.sizerSigLabel)
        ...
        sizer_6.Add(self.lblInfo1, 0, 0, 0)
        sizer_6.Add(self.lblInfo2, 0, 0, 0)
        sizer_6.Add(self.lblInfo3, 0, 0, 0)
        sizer_6.Add(self.lblInfo4, 0, 0, 0)
        sizer_6.Add(self.lblInfo5, 0, 0, 0)
        sizer_6.Add(self.lblInfo6, 0, 0, 0)
